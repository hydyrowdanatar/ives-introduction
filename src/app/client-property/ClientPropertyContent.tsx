// app/client-property/ClientPropertyContent.tsx  ← move logic here
"use client";
...
export default function ClientPropertyContent() {
  ...
  return (
    <div className="w-full flex flex-col items-center justify-center">
      <div className="w-full lg:w-[86%] lg:h-[595px] xl:h-[750px] 2xl:h-[885px] 3xl:h-[1155px] flex flex-col gap-[45px] lg:flex-row items-center justify-between py-11 px-6 lg:py-0 lg:px-0">
