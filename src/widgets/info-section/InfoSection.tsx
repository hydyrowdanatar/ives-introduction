...
const InfoSection: FC<IProps> = ({
  ...
  return (
    <div className="w-full lg:h-[450px] xl:h-[500px] 2xl:h-[590px] 3xl:h-[770px] bg-bright flex items-center justify-center py-11 px-6 lg:py-0 lg:px-0">
      <div className="w-full lg:w-[86%] mx-auto flex flex-col gap-5 lg:gap-[30px] lg:items-center">
        <div className="lg:text-center">
          <div>
            ...
            {isBrHave && <br />}
            <span
              className={`inline-block  ${italicColor} text-[22px] xl:text-[28px] 2xl:text-[33px] 3xl:text-[43px] leading-[28px] xl:leading-[33px] 2xl:leading-[39px] 3xl:leading-[50px]   font-normal italic`}
          ...
          <div className="mt-4 lg:mt-[30px]">
            <span
              className={`block ${regularColor} lg:w-[500px] xl:w-[630px] 2xl:w-[750px] mx-auto text-[13px] xl:text-[14px] 2xl:text-[17px] 3xl:text-[22px] pr-1 font-normal`}
            >
              {subTitle}
            </span>
          </div>
