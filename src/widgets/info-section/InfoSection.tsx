...
const InfoSection: FC<IProps> = ({
  ...
  return (
    <div className="w-full lg:h-[400px] xl:h-[500px] 2xl:h-[590px] 3xl:h-[770px] bg-bright flex items-center justify-center">
      <div className="w-[86%] mx-auto flex flex-col gap-[30px] items-center">
        <div className="text-center">
          ...
          <div className="mt-[30px]">
            <span
              className={`block ${regularColor} w-[500px] xl:w-[630px] 2xl:w-[750px] mx-auto text-[11px] xl:text-[14px] 2xl:text-[17px] 3xl:text-[22px]  font-normal`}
            >
              {subTitle}
            </span>
          </div>
        ...
        {bottomSubTitle && (
          <p className="mt-[30px] text-center text-[16px] xl:text-[20px] 2xl:text-[24px] 3xl:text-[30px]">
