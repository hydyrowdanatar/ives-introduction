      ...
      {isBrHave ? (
        <div>
          ...
          <span
            className={`inline-block ${italicColor} ${italicWidth} ${
              extraClassName
                ? "text-[20px] sm:text-[22px] xl:text-[28px] 2xl:text-[33px] 3xl:text-[43px] leading-[26px] sm:leading-[26px] xl:leading-[33px] 2xl:leading-[39px] 3xl:leading-[50px]"
                : "text-[27px] sm:text-[33px] xl:text-[42px] 2xl:text-[49px] 3xl:text-[64px] leading-[34px] sm:leading-[40px] xl:leading-[51px] 2xl:leading-[50px] 3xl:leading-[78px]"
            } font-normal italic`}
            style={{ fontFamily: "var(--font-taviraj)" }}
          >
            {italicText}
        ...
        >
          <span>{regularText}</span>
          <span
            className={`${italicColor} text-[27px] sm:text-[33px] xl:text-[42px] 2xl:text-[49px] 3xl:text-[64px] leading-[34px] sm:leading-[40px] xl:leading-[51px] 2xl:leading-[50px] 3xl:leading-[78px] font-normal italic`}
            style={{ fontFamily: "var(--font-taviraj)" }}
          >
            {italicText}
          </span>
